...
\emph{``After one reshuffled pass, the law of the next iterate depends only on the epoch’s starting point and the drawn permutation, but not its position within the permutation.''}\end{center}\vspace{-1em}
...
\end{theorem}
\vspace{-0.5em}
\subsection{Outer loop}\vspace{-0.75em}
