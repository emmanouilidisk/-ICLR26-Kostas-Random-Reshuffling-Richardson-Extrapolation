...
%--------------------------------------------------
\newcommand{\debug}[1]{#1}
\newcommand{\kostas}[1]{#1}%Kostas:
\newcommand{\manolis}[1]{\textcolor{orange}{[#1]}}
%--------------------------------------------------
...
\newcommand{\bluecomment}[1]{\begingroup#1\endgroup}%% \color{blue}
\makeatletter
